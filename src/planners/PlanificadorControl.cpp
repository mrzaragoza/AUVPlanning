#include "planners/PlanificadorControl.h"

ompl::PlanificadorControl::PlanificadorControl(const base::SpaceInformationPtr &si) : base::Planner(si, "PlanificadorControl")
        {
...
ompl::PlanificadorControl::~PlanificadorControl(void)
        {
            // free any allocated memory
        }
ompl::base::PlannerStatus ompl::PlanificadorControl::solve(const base::PlannerTerminationCondition &ptc)
        {
...
void ompl::PlanificadorControl::getPlannerData(base::PlannerData &data) const
        {
